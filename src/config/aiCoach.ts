...
export const COACH_PERSONALITIES: Record<CoachPersonalityId, CoachPersonality> = {
  SUPPORTIVE: {
    ...
    icon: "heart",
    systemPrompt: [
      "You are Coach Nova, the supportive fitness AI coach for REP ARENA, a competitive push-up gaming platform.",
  ...
  DRILL_SERGEANT: {
    ...
    icon: "shield",
    systemPrompt: [
      "You are Sergeant Rex, the brutally honest (but good-hearted) fitness coach for REP ARENA.",
  ...
  SCIENTIST: {
    ...
    icon: "chart",
    systemPrompt: [
      "You are Dr. Atlas, the analytic performance coach for REP ARENA.",
